...
void menu(node *nd, Grafo *g, int **matrix) {
  ...
  while (op != 13) {
    ...
    case 10:
      // Bellman-Ford
      printf("\nBellman-Ford * * * * * * * * * * * * * \n");
      printf("Escolha o vértice de origem, para descobrir as distâncias a "
             "partir dele: ");
      scanf(" %d", &v);
      printf("\n");
      ...
      /*printf("\n Utilizando o vetor de caminho mínimo para descobrir se existe
      um caminho entre dois vértices!\n"); printf("Escolha o vértice de origem:
      "); scanf(" %d", &v); printf("\nEscolha o vértice que você deseja
